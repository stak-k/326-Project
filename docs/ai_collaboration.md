...
In Project 4, I forced AI more for system-level thinking rather than individual functions. This included understanding CSV persistence, how to safely load and validate imported data, how to use context managers (with statements), and how to design unit, integration, and system tests using unittest. AI helped me confirm whether my tests actually represented real workflows, such as saving data, loading it in a new session, and rejecting corrupted files.

Overall, AI acted as a guided learning tool, similar to a tutor or documentation assistant. It helped me grow more confident in Python, testing, validation, and system integration while keeping full responsibility for the final implementation. This collaboration improved both my technical skills and my ability to think critically about code design and testing practices.

### Nick 

Throughout the duration of this project, I used AI in a number of different ways. During every project, I mostly filled in gaps that needed to be filled. So if I needed to add in functions where their primary functions were outlined, I did it, if I needed to naked a new function up, I did it. There was also a lot of annotation and explanation involved in this process. That is largely where I used AI. Considering how my work was so mismatched and jumbled in with my partners, it is difficult to tell exactly where I used AI and where I didn’t. But I can recall using AI to write a number of explanations and design a number of functions. Looking through my commits, the last one I did was going through and adding docstrings to a number of functions within the rental_type and type_score methods. This was done using both AI and myself. 
